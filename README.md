...
<i> Mixing GDAL + OTB + QGIS in a virtual environment </i>
...
<i>Details on steps required to perform SVM, RF and NN classification with the code elements is described in the .pdf document.</i>
