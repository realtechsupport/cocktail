...
<i> Resource constrained satellite asset collection and analysis </i>
<br><br>
...
Cocktail demonstrates how to setup a virtual computer that can support GDAL, OTB and QGIS functionality. It also includes examples of how to use the setup to apply various classifiers including vector support machines, random forests and neural networks across GDAL, OTB and QGIS.
...
<i>Details on how to perform make use of tip and cue, and how to perform SVM, RF and NN classifications is described in the .pdf document.</i>
