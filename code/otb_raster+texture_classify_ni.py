# COCKTAIL
# otb_raster_classify+texture_ni.py
# RTS, March 2022
#---------------------------------------------------------------------------------
# non_interactive version of otb_raster+texture_classify.py for use with
# otb_vary_raster_classify.py

# raster classifier training and image classification, includes texture information
