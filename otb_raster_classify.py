...
try:
	...
	classifier_type = jdata['raster_classifier_svm']
...
classifier_type = jdata['raster_classifier_rf']	#rf, libsvm, ann
...
app.SetParameterString("classifier", classifier_type)
