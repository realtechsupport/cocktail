...
# ------------------------------------------------------------------------------
# Combine with texture map that produces the following texture measures:
...
#------------------------------------------------------------------------------
	...
	#h_channel = 2 				# R,G,B = 1,2,3, IR =4
	xrad = 2; yrad = 2
	#texture_map = "haralicktexture_channel_" + str(h_channel) + ".tif"
