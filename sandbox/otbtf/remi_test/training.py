...
ds_train = create_dataset(
    ["/home/otbuser/all/data/output/train_p_patches.tif"],
    ["/home/otbuser/all/data/output/train_xs_patches.tif"],
    ["/home/otbuser/all/data/output/train_labels_patches.tif"],
)

ds_valid = create_dataset(
    ["/home/otbuser/all/data/output/valid_p_patches.tif"],
    ["/home/otbuser/all/data/output/valid_xs_patches.tif"],
    ["/home/otbuser/all/data/output/valid_labels_patches.tif"],
)

ds_test = create_dataset(
    ["/home/otbuser/all/data/output/test_p_patches.tif"],
    ["/home/otbuser/all/data/output/test_xs_patches.tif"],
    ["/home/otbuser/all/data/output/test_labels_patches.tif"],
)
