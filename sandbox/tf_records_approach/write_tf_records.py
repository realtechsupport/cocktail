...
# machine name of the user's vm
username = os.getenv("USER") or os.getenv("LOGNAME")

## Argument parsing for bucket name
parser = argparse.ArgumentParser(description='Writes TFRecords to GCS')

parser.add_argument('--bucket_name', type=str, default='tf_records_bucket',
                    help='Mention the name of bucket to store TFRecords')
...
folder_path = f'/home/{username}/project/images/'

# Specify the folder path where your labels are located
label_folder = f'/home/{username}/project/labels/'
