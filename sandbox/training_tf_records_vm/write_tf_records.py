...
folder_path = f'/home/{machine}/project/images/'

# Specify the folder path where your labels are located
label_folder = f'/home/{machine}/project/labels/'

#Specify the path where your clipping mask are located
geojson_datapath = f'/home/{machine}/project/labels/newextent_1123.geojson'
...
if __name__ == "__main__":
    ...
    machine = 'jay' #change the name of machine to your machine name
